# Firejail profile for luanti
# Description: Multiplayer infinite-world block sandbox
# This file is overwritten after every install/update
# Persistent local customizations
include luanti.local
# include minetest.profile
# Persistent global definitions
include globals.local
# In order to save in-game screenshots to a persistent location,
# edit ~/.luanti/luanti.conf:
# screenshot_path = /home/<USER>/.luanti/screenshots

noblacklist ${HOME}/.cache/luanti
noblacklist ${HOME}/.luanti
...
mkdir ${HOME}/.cache/luanti
mkdir ${HOME}/.luanti
whitelist ${HOME}/.cache/luanti
whitelist ${HOME}/.luanti
whitelist /usr/share/games/luanti
whitelist /usr/share/luanti
